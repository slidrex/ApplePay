    ...
    public Dictionary<string, EffectTemplate> Effects 
    {
        get
        {
            effects = new Dictionary<string, EffectTemplate>
            {
                ...
                ["instant_healh"] = new EffectTemplate(new PayWorld.EffectController.EffectDisplay(null, "Instant heal", "", null), byte.MaxValue, EffectType.Positive, new EffectProperty(States.ChangeHealth(Level * 5))),
