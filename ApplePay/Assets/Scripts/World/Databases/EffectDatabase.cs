...
namespace PayWorld.Effect
{
    public class EffectDatabase
    {
        ...
        public static string ColorizeText(string text, string colorHex) => Pay.Functions.String.SetRichTextTag(text, "color", colorHex);
        public static string ColorizeRoman(byte level, string colorHex) => ColorizeText(Pay.Functions.Generic.RomanConverter(level), colorHex);
